...
/**
 * Canonical tagged attestation payload and its SHA-256 digest.
 *
 ...
 */
data class AddressAttestationChallenge(
  val version: UByte,
  ...
  companion object {
    const val TAG: String = "BKAddressAttestation/v1"
    ...
    fun create(
      ...
      return AddressAttestationChallenge(
        version = version,
        network = network,
        address = address,
        scriptPubKey = scriptPubKey,

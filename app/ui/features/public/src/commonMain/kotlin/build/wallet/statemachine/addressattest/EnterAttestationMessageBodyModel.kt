...
data class EnterAttestationMessageBodyModel(
  ...
  val onContinue: () -> Unit,
    ...
    id = AddressAttestationEventTrackerScreenId.ENTER_MESSAGE,
    onBack = onBack,
    ...
    mainContentList = immutableListOf(
      TextInput(
        ...
        fieldModel = TextFieldModel(
          ...
          testTag = "address-attestation-message-input",
          onValueChange = { newValue, _ -> onMessageChanged(newValue) },
          keyboardType = Default,
          focusByDefault = true,
          maxLength = AttestationMessage.MAX_LENGTH
        )
      )
    ),

...
class SettingsHomeUiStateMachineImplTests : FunSpec({
  ...
  val proveAddressFeatureFlag = ProveAddressFeatureFlag(FeatureFlagDaoFake())
  ...
  fun stateMachine(appVariant: AppVariant = AppVariant.Customer) =
    SettingsHomeUiStateMachineImpl(
      ...
      proveAddressUiStateMachine = object : ProveAddressUiStateMachine,
        ScreenStateMachineMock<ProveAddressUiProps>("prove-address") {},
      proveAddressFeatureFlag = proveAddressFeatureFlag,
